...
from linearmodels.shared.utility import AttrDict, ensure_unique_column
...
def lasso(X, y, alpha):
    mod = Lasso(alpha, fit_intercept=False)
    mod.fit(X, y)
    return mod.coef_
...
EXOG_PREDICT_MSG = """exog does not have the correct number of columns. Saw {x_shape}, expected
